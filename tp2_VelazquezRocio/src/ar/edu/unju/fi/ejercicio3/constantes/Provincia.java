...
public enum Provincia {
	JUJUY(811611,53219.0),SALTA(1440672,155488.0),TUCUMÁN(1731820,22524.0),CATAMARCA(429562,102602.0),LARIOJA(383865,89680.0),SANTIAGODELESTERO(1060906,136351.0);
	//ATRIBUTOS
